...
const Hero = () => {
  ...
  return (
    <section className="flex justify-center items-center flex-col mt-10 md:mt-20">
      <figure>
        <Image
      ...
      <p className={`${poppins.className} font-light text-[22px] md:text-5xl`}>
        I am{" "}
      ...
      >
        ...
        <span
          className="!font-bold"
          style={{ color: colorInterceptor.getColorClass("secondary_color") }}
        >
          <FlipWords
